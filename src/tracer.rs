...
use crate::{
    evm::utils::prettify_concise_inputs, generic_vm::vm_state::VMStateT, input::ConciseSerde,
    ...
    CI: Serialize + DeserializeOwned + Debug + Clone + ConciseSerde,
{
        ...
        Loc: Debug + Serialize + DeserializeOwned + Clone,
    {
        ...
        // Try to reconstruct transactions leading to the current VMState recursively
        let mut res =
            Self::get_concise_inputs(&testcase_input.as_ref().unwrap().trace.clone(), state);
