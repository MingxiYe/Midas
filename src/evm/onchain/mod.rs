...
use crate::{
    evm::{
        ...
        onchain::{
            abi_decompiler::fetch_abi_heimdall, endpoints::OnChainConfig,
            flashloan::register_borrow_txn,
        },
    ...
    unsafe fn on_step(
        ...
        match *interp.instruction_pointer {
            ...
            0xf1 | 0xf2 | 0xf4 | 0xfa | 0x3b | 0x3c => {
                ...
                let should_setup_abi =
                    *interp.instruction_pointer != 0x3b && *interp.instruction_pointer != 0x3c;
                self.load_code(
                    address_h160,
                    host,
                    force_cache,
